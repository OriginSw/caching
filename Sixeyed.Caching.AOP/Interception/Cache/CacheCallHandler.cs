...
namespace Sixeyed.Caching.AOP.Interception.Cache
{
    /// <summary>
    ...
    public class CacheCallHandler : ICallHandler
    {
        ...
        {            
            ...
            var cache = Caching.AOP.Cache.Get(cacheAttribute.CacheType);
            var serializer = cache.Serializer.Get(cacheAttribute.SerializationFormat);
