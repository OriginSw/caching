...
namespace Sixeyed.Caching.AOP.Extensions
{
    /// <summary>
    ...
    public static class IMethodInvocationExtensions
    {
        ...
        /// <returns></returns>
        public static string ToTraceString(this IMethodInvocation invocation, ISerializer argumentSerializer)
        {
            return ToTraceString(invocation, argumentSerializer, null, true, ": ", ", ");
        }
